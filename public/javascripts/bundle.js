...
/***/ function(module, exports, __webpack_require__) {
	...
	if(isServer){
	  ...
	  function wrapWithLayout(locals, callback) {
	    try {
	      var layout = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({displayName: "App",
	  render:function(){
	    return(
	      React.createElement(Search, {"data-renderer": this.props.renderer})
	    );
	  }
	});
	  ...
	  render:function() {
	    return (
	      React.createElement("div", {className: "search-component"}, 
	        React.createElement("a", {href: "/test"}, "routing test"), 
	        ...
	        React.createElement("p", null, "renderer = ", this.props['data-renderer'])
	      )
	    );
	  },
	...
	var Test = React.createClass({displayName: "Test",
	  ...
	  render:function() {
	    return (
	      React.createElement("div", {className: "search-component"}, 
	        React.createElement("input", {type: "text", onChange: this.changeSearch}), 
	        React.createElement("p", null, React.createElement("span", null, "Test for: ", this.state.search)), 
	        React.createElement("p", null, "renderer = ", this.props.renderer)
	      )
	    );
	  },
